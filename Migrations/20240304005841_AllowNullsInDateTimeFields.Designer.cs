...
namespace RoutesManagementSystem.API.Migrations
{
    ...
    [Migration("20240304005841_AllowNullsInDateTimeFields")]
    partial class AllowNullsInDateTimeFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoutesManagementSystem.API.Entities.Settlement", b =>
                {
                    b.HasOne("RoutesManagementSystem.API.Entities.LastMileRoute", "LastMileRoutes")
                        .WithMany("Settlements")
                        .HasForeignKey("RouteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LastMileRoutes");
                });
